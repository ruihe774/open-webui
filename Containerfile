...
RUN --mount=type=bind,source=dist,target=/dist uv pip install /dist/open_webui-0.6.4-py3-none-any.whl --extra-index-url https://download.pytorch.org/whl/cpu --index-strategy unsafe-best-match
